...
var canvasBg = document.getElementById("canvasBg"),
    ...
    obstacles = [],
    isPlaying = false,
    // AnimationFrame for various browsers
...
// if our player is alive, keep playing!
function loop() {
    if (isPlaying) {
        update();
        draw();
...
// random function for random play
...
// e.g. running north, facing north
Player.prototype.checkDirection = function () {
    ...
    // did Player collide with an obstacle (tree or rock, etc)?
    obstacleCollision = this.checkObstacleCollide(newDrawX, newDrawY);
    
    // if our Player hasn't collided AND he's in bounds- set his new position
...
// Loop through obstacles array to check for Player collision
...
// Is Player shooting? 
// If user presses the spacebar, then yes he is!
// Pause between shots. It's a single-shooter. Chill, man.
...
// Make sure Player has enough bullets to keep fighting.
// Update his arsenal.
...
// If the bullet isFlying, draw it.
...
// Bullet object. (constructor function)
function Bullet() {
    this.radius = 2;
...
// update the bullet's position as it darts across the board
// did it hit an enemy? obstacle? or fly out of bounds?
...
// user input (arrow keys) determine Player direction.
...
// loop through enemies array to see if 
// any of the enemies have been hit by a bullet 
// if the enemy is already dead, another bullet hit doesn't count
...
// loop through obstacles array to 
// see if the bullet hit a lonely tree or rock
...
// did a stray bullet leave our board?
...
// which direction is Enemy facing?
...
// Set Enemy movement limits. 
// Can't go more than 50 in any direction. (per move)
// Can't exit canvas width or height. 
...
// Update Enemy position based on direction facing
...
// When Enemy dies, play dying sound.
...
// User input (arrow keys) determine keyboard value
...
// Did Player's bullet collide with an enemy 
// or obstacle? (tree, rock, etc)?
